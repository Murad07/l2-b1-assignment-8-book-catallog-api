...
const getSilgleBook = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const page = parseInt(req.query.page) || 1;
    const size = parseInt(req.query.size) || 10;
    const id = req.params.id;
    const resultB = yield book_service_1.BookService.getSilgleBook(id);
    if (!resultB) {
        const resultC = yield book_service_1.BookService.getBookByCategory({
            id,
            page,
            size,
        });
